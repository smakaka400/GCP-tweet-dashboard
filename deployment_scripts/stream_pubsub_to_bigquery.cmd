...
python ../python_scripts/beam_pubsub_to_bigquery.py --streaming --runner=DirectRunner --temp_location=gs://%GCS_BUCKET% --subscription=%SUBSCRIPTION% --projectId=%PROJECT% --datasetId=%DATASET% --tableId=%TABLE%